...
class NuScenesMonoDataset_copy(CocoDataset):
    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        for i, ann in enumerate(ann_info):
            # print(".....................ann.....nuscenes_mono_dataset_copy.py.................\n", ann)
            # exit()
            ...
            if ann.get('iscrowd', False):
                ...
                depths.append(depth)
                # print("..............depths............in nuscenes_mono_dataset_copy.......",i, depths)
                # exit()
                ...
                relative_velo.append(ann['relative_velo'])
                ego_obj_distance.append(ann['ego_obj_distance'])
                time_to_coll.append(ann['time_to_coll'])
                # velo_global3d.append(np.array(ann['velo_global3d']).reshape(1, -1))
                # relative_velo_global3d.append(np.array(ann['relative_velo_global3d']).reshape(1, -1))
        ...
        if gt_bboxes_cam3d:
            ...
            relative_velo = np.array(relative_velo, dtype=np.float32)
            ego_obj_distance = np.array(ego_obj_distance, dtype=np.float32)
            time_to_coll = np.array(time_to_coll, dtype=np.float32)
            # ## New
            ...
            relative_velo = np.zeros((0, 2), dtype=np.float32)
            ego_obj_distance = np.array([], dtype=np.float32)
            time_to_coll = np.array([], dtype=np.float32)
            # ## New
        ...
        ann = dict(
            ...
            relative_velo=relative_velo,
            ego_obj_distance=ego_obj_distance,
            time_to_coll=time_to_coll
            # ## New            
            )
        # print("..................Annotation Sample.........nuscenes_mono_dataset_copy.py.......",list(ann.items()))
        # exit()
        return ann
    ...
    def _format_bbox(self, results, jsonfile_prefix=None):
        ...
        for sample_id, det in enumerate(mmcv.track_iter_progress(results)):
            ...
            for i, box in enumerate(boxes):
                # print('..................box............in nuscenes_mono_dataset_copy.py......\n', box)
                # exit()
                ...
                # print("..........box.....in nuscenes_mono_dataset_copy.py....",box)
                # exit()
                ...
                box.rotate(pyquaternion.Quaternion(ego2global_rotation).inverse)

                # Move box to camera coord system
                box.translate(-np.array(cam2ego_translation))
                box.rotate(pyquaternion.Quaternion(cam2ego_rotation).inverse)
                ...
                # print("..........nusc_anno.....in nuscenes_mono_dataset_copy.py....",nusc_anno)
                # exit()
                ## New
    ...
    def evaluate(self,
        ...
        # print('.......result_files....in def evaluate()..in nuscenes_mono_dataset_copy.py......\n', result_files)
        # exit()
...
#                 # New
#                 box.relative_velocity = relative_velocity
#                 box.ttc = np.linalg.norm(np.array(ego_translation)) / np.linalg.norm(np.array(relative_velocity))
#                 ## New
#             else:
