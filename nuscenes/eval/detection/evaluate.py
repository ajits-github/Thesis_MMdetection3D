    ...
    def evaluate(self) -> Tuple[DetectionMetrics, DetectionMetricDataList]:
        ...
        for class_name in self.cfg.class_names:
            for dist_th in self.cfg.dist_ths:
                # for gt_box, pred_box in zip(self.gt_boxes, self.pred_boxes):
                #     var = len(gt_box) > 0 and len(pred_box) > 0
                #     # print(".......var..............in nuscenes\eval\detection\evaluate.py.", var)
                    # if len(gt_box) > 0:
                    #     print("..............self.gt_boxes......in nuscenes\eval\detection\evaluate.py.............\n",gt_box)
                    #     print("..............self.pred_boxes.....in nuscenes\eval\detection\evaluate.py.............\n",pred_box)
                    #     # print("..............self.pred_boxes.....in nuscenes\eval\detection\evaluate.py.............\n",pred_box)
                    #     exit()
